# LSM6DS3TR-C — Legacy Extraction Archive

> **Audit archive; do not implement from this file.** This monolithic
> extraction is retained so no previously collected source material is lost,
...
> `XL_HM_MODE`, invalid FIFO value `0x66`, invalid wrist mask `0x02`, wrong
> pedometer/soft-iron defaults, and noncanonical self-test procedures. They are
> intentionally not silently rewritten here because this file preserves the
> historical extraction for audit. Never copy a register literal or sequence
> from this archive into production code.
