...
- Android M compliant ST’s family of MEMS sensor modules leverages the
...
ODR < 1.6 kHz 150
LA_IddHP consumption μA
ODR ≥ 1.6 kHz 160
in high-performance mode
Accelerometer current
LA_IddNM ODR = 208 Hz 85 μA
consumption in normal mode
Accelerometer current
LA_IddLM ODR = 12.5 Hz 9 μA
consumption in low-power mode
Gyroscope and accelerometer
IddPD current consumption during 3 μA
power-down
...
t h(SDA) SDA data hold time 0 3.45 0 0.9 μs
...
(SCL) (400 kHz max)
t SCL clock low time 5.86 1.3 μs
w(SCLL)
...
t Repeated START condition setup time 1.56 0.6 μs
su(SR)
t Repeated START condition hold time 1.56 0.6 μs
su(HD)
t STOP condition setup time 2.73 0.6 μs
su(SP)
t Bus free time between STOP and START condition 21 1.3 μs
w(SP:SR)
